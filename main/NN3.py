...
import time
import sys
sys.path.append("/Users/tahauygun/ML CLASS/ml-assignment2/tuygun3-assignment2/main/ABAGAIL/ABAGAIL.jar")
...
from func.nn.activation import RELU, HyperbolicTangentSigmoid, LogisticSigmoid
...
def main(P,mate,mutate):
    ...
    classification_network = factory.createClassificationNetwork([INPUT_LAYER, HIDDEN_LAYER1,HIDDEN_LAYER2,HIDDEN_LAYER3, OUTPUT_LAYER],tanh)
...
if __name__ == "__main__":
    for p in [50, 100]: #population size
        for mate in [10, 20]: #number of population to mate each step
            for mutate in [10, 20]: #number of population to mutate each step
                args = (p,mate,mutate)
                main(*args)
